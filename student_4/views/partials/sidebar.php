...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        <a href="/online-auction-system/student_4/views/admin_dashboard.php"
           class="nav-item <?= $currentPage === 'admin_dashboard.php' ? 'active' : '' ?>">
            <span class="nav-icon">▣</span> Dashboard
        </a>

        <a href="/online-auction-system/student_4/views/auctions.php"
           class="nav-item <?= $currentPage === 'auctions.php' ? 'active' : '' ?>">
            <span class="nav-icon">◈</span> Auctions
        </a>

        <a href="/online-auction-system/student_4/views/users.php"
           class="nav-item <?= $currentPage === 'users.php' ? 'active' : '' ?>">
            <span class="nav-icon">◉</span> Users
        </a>

        <a href="/online-auction-system/student_4/views/categories.php"
           class="nav-item <?= $currentPage === 'categories.php' ? 'active' : '' ?>">
            <span class="nav-icon">◎</span> Categories
        </a>

        <a href="/online-auction-system/student_4/views/seller_requests.php"
        ...
        <a href="/online-auction-system/student_4/views/reports.php"
    ...
    <div class="sidebar-footer">
        ...
        <a href="/online-auction-system/student_4/views/logout.php" class="logout-btn">
            Log out →
        </a>
    </div>
</aside>