...
if ($user) {
    ...
    if ($user['role'] === 'admin') {
        echo "<li><a href='/student_4/views/admin_dashboard.php'>Admin Dashboard</a></li>";
        echo "<li><a href='/student_4/views/auctions.php'>View All Auctions</a></li>";
        echo "<li><a href='/student_4/views/reports.php'>Reports</a></li>";
    } elseif ($user['seller_verified']) {
        echo "<li><a href='/student_4/views/seller_dashboard.php'>My Seller Dashboard</a></li>";
        echo "<li><a href='/student_4/views/my_bids.php'>My Bids</a></li>";
    } else {
        echo "<li><a href='/student_4/views/my_bids.php'>My Bids</a></li>";
        echo "<li><a href='/auction_project/views/browse.php'>Browse Auctions</a></li>";
    }
    ...
    echo "<ul>";
    echo "<li><code>/student_4/views/contact_info.php?listing=1</code> (replace 1 with actual listing ID)</li>";
    echo "</ul>";
